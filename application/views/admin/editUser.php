          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="firstname" value="<?php echo $user_details['firstname']; ?>" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label>Lastname</label>
                  <input class="form-control" type="text" name="lastname" value="<?php echo $user_details['lastname']; ?>" />
                </div>
              </div>
            </div>
            <div class="form-group">
              <label>Email Address</label>
              <input class="form-control" type="text" name="email" value="<?php echo $user_details['email']; ?>" />
            </div>
            ...
            <div class="row">
              <div id="sandbox-container" class="form-group col-md-6">
                ...
                <input type="text" name="premium_until" class="form-control" value="<?php echo $user_details['premium_until_formatted']; ?>">
              </div>
              <div class="col-md-6">
